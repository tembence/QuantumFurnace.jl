...
def liouvillian_step(initial_dm: np.ndarray, mixing_time: float, delta: float, jump_ops: list[np.ndarray],
                     num_labels: int, sigma: float, hamiltonian: HamHam) -> np.ndarray:
    ...
