...
function coherent_gaussian_timedomain(jump::JumpOp, hamiltonian::HamHam, time_labels::Vector{Float64}, beta::Float64)
    ...
    indices_b1, indices_b2 = get_truncated_indices_b1b2(time_labels, b1, b2)
    ...
    for (i, t) in enumerate(b1_times)
        ...
        for (j, s) in enumerate(b2_times)
            ...
            b2_sum .+= b2[j] * time_evolution_inner * 
...
function get_truncated_indices_b1b2(time_labels::Vector{Float64}, b1::Vector{ComplexF64}, 
