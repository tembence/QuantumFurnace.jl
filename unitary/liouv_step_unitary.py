...
def liouv_step_circ(num_qubits: int, num_energy_bits: int, delta: float, hamiltonian: HamHam,
                    jump: tuple[Operator, int], initial_state: Statevector) -> QuantumCircuit:
    ...
    oft_circ = operator_fourier_circuit(jump, num_qubits, num_energy_bits, hamiltonian, 
    ...
    inverse_oft_circ = inverse_operator_fourier_circuit(jump, num_qubits, num_energy_bits, hamiltonian)
